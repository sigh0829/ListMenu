...
public class MenuItemImpl implements MenuItem {
    ...
    private static final int SHOW_AS_ACTION_MASK = SHOW_AS_ACTION_IF_ROOM|SHOW_AS_ACTION_ALWAYS;
    ...
    MenuItemImpl(MenuBuilder menu, int group, int id, int categoryOrder, int ordering,
        ...
        if (sPrependShortcutLabel == null) {
            ...
            sPrependShortcutLabel = "prepend";
            sEnterShortcutLabel ="enter";
            sDeleteShortcutLabel = "delete";
            sSpaceShortcutLabel ="space";
        }
    ...
    /**
     * Gets the title for a particular {@link MenuInterface.ItemView}
     *
     ...
     *         prefers
     */
    CharSequence getTitleForItemView(MenuInterface.ItemView itemView) {
